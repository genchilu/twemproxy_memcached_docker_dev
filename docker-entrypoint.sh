...
mc2=$(getent hosts mc1 | awk '{ print $1 }') && echo "   - ${mc2}:11211:1 mc2" >> /etc/nutcracker/nutcracker.yml
mc3=$(getent hosts mc1 | awk '{ print $1 }') && echo "   - ${mc3}:11211:1 mc3" >> /etc/nutcracker/nutcracker.yml
